...
final class ASMusicPlayerView: UIView {
    ...
    private func setupUI() {
        ...
        backgroundImageView.layer.cornerRadius = panelType == .large ? .responsiveWidth(self, 15) : .responsiveWidth(self, 5)
        setupButton()
        setupBlurView()
    ...
    private func compactLayout() {
        NSLayoutConstraint.activate([
            ...
            playButton.centerYAnchor.constraint(equalTo: backgroundImageView.centerYAnchor),
            playButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: .responsiveWidth(self, -24)),
        ])
    }
    ...
    private func setupButton() {
        ...
        let imageConfig = UIImage.SymbolConfiguration(pointSize: panelType == .large ? .responsiveWidth(self, 60) : .responsiveWidth(self, 32))
    ...
    private func setupBlurView() {
        ...
        blurView.layer.cornerRadius = .responsiveWidth(self, 15)
