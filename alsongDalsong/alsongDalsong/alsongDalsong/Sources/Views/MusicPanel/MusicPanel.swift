...
final class MusicPanel: UIView {
    ...
    private func setupNoMusicLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            noMusicLabel.leadingAnchor.constraint(greaterThanOrEqualTo: leadingAnchor, constant: .responsiveWidth(16)),
            noMusicLabel.trailingAnchor.constraint(lessThanOrEqualTo: trailingAnchor, constant: .responsiveWidth(-16)),
        ])
    }
    ...
    private func setupLabelStack() {
        ...
        labelStack.spacing = .responsiveHeight(0)
    ...
    private func largeLayout() {
        NSLayoutConstraint.activate([
            ...
            player.topAnchor.constraint(equalTo: topAnchor, constant: .responsiveHeight(24)),
            player.leadingAnchor.constraint(equalTo: leadingAnchor, constant: .responsiveWidth(24)),
            player.trailingAnchor.constraint(equalTo: trailingAnchor, constant: .responsiveWidth(-24)),
            player.bottomAnchor.constraint(equalTo: labelStack.topAnchor, constant: .responsiveHeight(-12)),

            labelStack.centerXAnchor.constraint(equalTo: centerXAnchor),
            labelStack.widthAnchor.constraint(equalTo: player.widthAnchor, constant: .responsiveWidth(-16)),
            labelStack.bottomAnchor.constraint(equalTo: bottomAnchor, constant: .responsiveHeight(-24)),
        ])
    }
    ...
    private func compactLayout() {
        NSLayoutConstraint.activate([
            ...
            player.topAnchor.constraint(equalTo: topAnchor, constant: .responsiveHeight(12)),
            player.bottomAnchor.constraint(equalTo: bottomAnchor, constant: .responsiveHeight(-12)),
            player.leadingAnchor.constraint(equalTo: leadingAnchor, constant: .responsiveWidth(12)),
            player.trailingAnchor.constraint(equalTo: trailingAnchor),

            labelStack.centerXAnchor.constraint(equalTo: centerXAnchor, constant: .responsiveWidth(8)),
            labelStack.widthAnchor.constraint(equalToConstant: .responsiveWidth(160)),
