...
class AudioAnalyzerView: UIView {
...
struct AudioVisualizerViewWrapper: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> AudioAnalyzerView {
        let visualizer = AudioAnalyzerView(frame: .zero)
        return visualizer
    }
    
    func updateUIView(_ uiView: AudioAnalyzerView, context: Context) {
