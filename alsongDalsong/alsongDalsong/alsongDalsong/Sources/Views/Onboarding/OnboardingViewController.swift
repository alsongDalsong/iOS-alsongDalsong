...
final class OnboardingViewController: UIViewController {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            nickNamePanel.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: .responsiveWidth(41)),
            nickNamePanel.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: .responsiveWidth(-41)),
