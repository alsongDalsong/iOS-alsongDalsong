...
final class HummingViewController: UIViewController {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            musicPanel.topAnchor.constraint(equalTo: scrollView.contentLayoutGuide.topAnchor, constant: .responsiveHeight(view, 32)),
            ...
            buttonStack.bottomAnchor.constraint(equalTo: safeArea.bottomAnchor, constant: .responsiveHeight(view, -16)),
